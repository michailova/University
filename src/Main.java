...
//        array[2] = new Student("Pit", "Ivanov", 18, addressStudent3);
        ...
        Teacher teacher1 = new Teacher("Mary", "Petrovna", 32, addressTeacher1);
        Group group1 = new Group(110418, 2, array, teacher1);
        teacher1.setBasePay(600);
        teacher1.setWorkDays(5);

        //Student studDel = new Student ("Sam", "Ivanov", 19, addressStudent2);
        //group1.setRemoveStud();
